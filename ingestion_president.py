...
if __name__ == '__main__':
    ...
    # 1. 랭체인 문서 불러오기
    file_path = '/Users/dasom/somi/github.com/dasom222g/learn-vector-dbs/president_doc.txt'
    ...
    # 4-1. 벡터스토어 생성 및 저장
    vector_store = PineconeVectorStore.from_documents(documents=chunked_docs, embedding=embeddings, index_name=os.getenv('INDEX_NAME_PRESIDENT'))
